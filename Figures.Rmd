...
fig2 <-ggarrange(a, b, nrow = 2, heights = c(5, 8), labels = c("a", "b"))
...
snow_for_graphs %>% 
  ...
  labs( y = "Centimeters", x = "Year (1931-2018)", color = "Rate of loss (cm per decade)", title = "Pinkham Notch snow record")+
  scale_color_gradient(low = "#C0000070", high = "#C00000")+
